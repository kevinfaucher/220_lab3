...
Player::Player() {
    // constructor for an actual human, that uses cin to ask the user for their name 
...
Player::Player(string n, char ic, bool x) {
    ...
    // and a Boolean value x and sets the name, the c, and the 
    //isComputer fields accordingly.  It initializes the score to 0
    name = n; //set name as 'n'
    c = ic; //set c as 'ic'
    isComputer = x; //set isComputer according to x value
    score = 0;
}